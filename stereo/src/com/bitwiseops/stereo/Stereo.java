...
public class Stereo {
    ...
    public void render() {
        ...
        /*
         * GL11.glPushMatrix(); GL11.glTranslatef(0, 0, (float)Math.sin(time *
         * 6.0f)); GL11.glRotatef(time * 30.0f, 0, 0, 1);
         * GL11.glBegin(GL11.GL_TRIANGLE_STRIP); GL11.glVertex3f(-1, -1, -4);
         * GL11.glVertex3f(-1, 1, -4); GL11.glVertex3f(1, -1, -4);
         * GL11.glVertex3f(1, 1, -4); GL11.glEnd(); GL11.glPopMatrix();
         */
